	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/info/flatform/app/appinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
...
<script src="${pageContext.request.contextPath }/statics/localjs/appinfolist2.js"></script>